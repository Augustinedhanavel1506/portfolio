  ...
  return (
    <div className="icons-section">
      <div className="social-icons" data-cursor="icons" id="social">
        <span>
          <a href="https://github.com/Augustinedhanavel1506" target="_blank" rel="noreferrer">
            <FaGithub />
          </a>
        </span>
        <span>
          <a href="https://www.linkedin.com/in/augustine-d-db1506202" target="_blank" rel="noreferrer">
            <FaLinkedinIn />
          </a>
        </span>
      </div>
